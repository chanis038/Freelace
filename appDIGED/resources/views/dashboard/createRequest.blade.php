...
@section('contentDash')
      ...
      <div class=" col-xs-6 col-ms-6 col-md-4 mb-3">
                ...
                <input type="text" class="form-control" name="monto" placeholder="10" value="" maxlength=12 required></div>

               <div class=" col-xs-6 col-ms-6 col-md-3 mb-3">
                <label for="monto_letras">Monto en Letras</label>
                <input type="text" class="form-control" name="monto_letras" placeholder="dies quetzales exactos" value="" maxlength=191 required>
               </div>
